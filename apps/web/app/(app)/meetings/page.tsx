...
export default function MeetingsPage() {
 ...
 return (
  <div className="space-y-6">
   {/* Header */}
   <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white border border-slate-200 rounded-xl p-4 sm:p-6 shadow-sm">
    <div>
     <h2 className="text-xl font-bold text-slate-900 tracking-tight">SSIE Meetings Hub</h2>
   ...
   {successMessage && (
    <div className="p-4 bg-emerald-50 border border-emerald-200 rounded-xl text-xs font-medium text-emerald-800 ">
     {successMessage}
    </div>
   )}
