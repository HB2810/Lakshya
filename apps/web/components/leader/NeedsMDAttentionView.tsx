...
export const NeedsMDAttentionView: React.FC<NeedsMDAttentionViewProps> = ({ onSelectItem }) => {
  ...
  const isMDOrMDOffice =
    ['MD', 'MD_OFFICE', 'MANAGING_DIRECTOR', 'MASTER', 'ADMIN'].includes(user.role) ||
          ...
          {filteredItems.map(item => {
            ...
            return (
              <div
                ...
                className="p-4 rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 hover:border-indigo-300 dark:hover:border-indigo-700 hover:shadow-xs transition-all cursor-pointer space-y-3"
              >
