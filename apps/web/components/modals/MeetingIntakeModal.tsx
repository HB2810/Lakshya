        ...
        {!candidatePlan ? (
          <div className="space-y-4">
            ...
            {isLoadingMeetings ? (
              ...
              <div className="p-4 bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-lg text-center text-xs text-slate-500">
              ...
              <div className="space-y-3">
                ...
                <select
                  ...
                  className="w-full p-2.5 text-sm bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-700 rounded-md text-slate-900 dark:text-white focus:outline-none focus:border-indigo-500"
                >
                  {meetings.map((m) => (
