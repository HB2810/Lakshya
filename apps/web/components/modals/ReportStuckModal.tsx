 ...
 return (
  <Modal isOpen={isOpen} onClose={onClose} title="Report Blocker / Flag Task as Stuck">
   <form onSubmit={handleSubmit} className="space-y-4">
    <div className="p-3 bg-red-50 border border-red-200 rounded-md flex items-center gap-2 text-xs font-medium text-red-700 ">
    ...
    {!taskId && (
     <div>
      ...
      <select
       ...
       className="w-full p-2 text-sm bg-slate-50 border border-slate-300 rounded-md text-slate-900 "
       required
      >
       {workItems.length === 0 ? (
    ...
    <div>
     ...
     <textarea
      ...
      required
      className="w-full p-2.5 text-sm bg-slate-50 border border-slate-300 rounded-md text-slate-900 "
     />
    </div>
